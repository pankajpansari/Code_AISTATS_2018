...
//    MatrixXf unaries = MatrixXf::Random(3, 5);
//    DenseCRF2D crf(size.width, size.height, 3);
    ...
    std::string path_to_subexp_results = results_path + "/" + dataset_name + "_" + method + "_" + std::to_string(spc_std) + "_" + std::to_string(spc_potts) + "_" + std::to_string(bil_spcstd) + "_" + std::to_string(bil_colstd) + "_" + std::to_string(bil_potts) + "_" + std::to_string(clique_weight)+ "/";
